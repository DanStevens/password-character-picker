...
function init() {
  ...
  prefs.on("maskPhraseInput", maskPhraseInputPrefChanged);
  maskPhraseInputPrefChanged();
}

function maskPhraseInputPrefChanged() {
  panel.port.emit("maskPhraseInput", prefs.prefs["maskPhraseInput"]);
}
